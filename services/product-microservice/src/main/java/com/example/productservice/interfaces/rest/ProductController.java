...
import com.example.productservice.application.DTOs.ProductValidationRequest;
import com.example.productservice.application.DTOs.ProductValidationResponse;
...
import com.example.productservice.domain.exception.AccessDeniedException;
import com.example.productservice.domain.exception.InvalidIdException;
import com.example.productservice.domain.exception.MissingMerchantIdException;
import com.example.productservice.interfaces.common.ApiResponse;
...
public class ProductController {
    ...
    public ResponseEntity<ApiResponse<List<ProductResponse>>> getAllProducts(
        ...
        ApiResponse<List<ProductResponse>> result = new ApiResponse<>(
                HttpStatus.OK,
                "get all products",
                getAllProductsUseCase.getAllProducts(merchantId),
                null);
