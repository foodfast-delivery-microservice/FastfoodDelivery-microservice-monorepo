    ...
    public ProductResponse create(ProductRequest productRequest) {
        ...
        if (existingProduct.isPresent()) {
            ...
            if (productRequest.getStock() != null) {
                product.restoreStock(productRequest.getStock());
            }
            if (productRequest.getDescription() != null) {
                product.setDescription(productRequest.getDescription());
            }
            if (productRequest.getPrice() != null) {
                product.setPrice(new Price(productRequest.getPrice()));
            }
            ...
            product.setDescription(productRequest.getDescription());
            product.setPrice(productRequest.getPrice() != null ? new Price(productRequest.getPrice()) : null);
            product.setStock(productRequest.getStock() != null ? new Stock(productRequest.getStock()) : null);
            product.setCategory(category);
