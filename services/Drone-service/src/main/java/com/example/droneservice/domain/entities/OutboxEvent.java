...
public class OutboxEvent {
    ...
    private Long id;
    private String aggregateType; // e.g., "Drone", "Mission"
    private String aggregateId; // e.g., mission ID or drone ID
    private String type; // e.g., "DroneAssigned", "DeliveryCompleted", "DroneStatusUpdate"
